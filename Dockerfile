...
COPY ./components/component-web-api-echo/go.mod ./components/component-web-api-echo/go.mod
COPY ./components/component-web-api-echo/go.sum ./components/component-web-api-echo/go.sum
...
COPY ./components/component-web-api-echo/ ./components/component-web-api-echo/
