...
// Source: ./components/component-services/intfRepo/IRatingRepo.go
...
func (m *MockIRatingRepo) GetByBookID(ctx context.Context, bookID uuid.UUID, limit, offset int) ([]*models.RatingModel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByBookID", ctx, bookID, limit, offset)
...
func (mr *MockIRatingRepoMockRecorder) GetByBookID(ctx, bookID, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByBookID", reflect.TypeOf((*MockIRatingRepo)(nil).GetByBookID), ctx, bookID, limit, offset)
}
