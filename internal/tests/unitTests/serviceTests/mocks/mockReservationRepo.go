...
// Source: ./components/component-services/intfRepo/IReservationRepo.go
...
func (m *MockIReservationRepo) GetByReaderID(ctx context.Context, readerID uuid.UUID, limit, offset int) ([]*models.ReservationModel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByReaderID", ctx, readerID, limit, offset)
	ret0, _ := ret[0].([]*models.ReservationModel)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIReservationRepoMockRecorder) GetByReaderID(ctx, readerID, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByReaderID", reflect.TypeOf((*MockIReservationRepo)(nil).GetByReaderID), ctx, readerID, limit, offset)
}
